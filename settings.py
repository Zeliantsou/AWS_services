...
AWS_ACCOUNT_ID = '059019534045'
AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY')
AWS_DEFAULT_REGION = os.environ.get('AWS_DEFAULT_REGION')
AWS_STORAGE_BUCKET_NAME = os.environ.get('AWS_STORAGE_BUCKET_NAME')
AWS_BUCKET_NAME_CSV = 'cereal-zelentsov-csv'
AWS_BUCKET_NAME_LAMBDA = 'cereal-zelentsov-lambda'
...
DIRECTORY_PATH_LAMBDA = 'lambda_functions/'  # for zip lambda
DIRECTORY_PATH_ZIP_STORAGE = 'lambda_zips_for_aws /'  # for zip lambda
